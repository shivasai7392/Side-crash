...
def main(*args):
    ...
    # From threed_metadb_file reading displacements
    ...
    # off the title and axis options and on the fringebar and updating the fringebar color to white instead of blue
