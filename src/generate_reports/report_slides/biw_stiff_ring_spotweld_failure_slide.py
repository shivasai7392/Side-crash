        ...
        try:
            ...
            for shape in self.shapes:
                ...
                if shape.name == "Image 1":
                    ...
                    utils.MetaCommand('read sesssion {}'.format(os.path.join(os.path.dirname(__file__),"annotation_positioning_session_files","f21_upb_outer.ses")))
                ...
                #image insertion for the shape named "Image 2"
                    ...
                    self.logger.info("SOURCE FILE FOR SPOTWELD ID'S : {}".format(self.general_input.d3hsp_file_path))
                    visualize_annotation(self.metadb_3d_input.spotweld_clusters,self.general_input.binout_directory)
                    utils.MetaCommand('read sesssion {}'.format(os.path.join(os.path.dirname(__file__),"annotation_positioning_session_files","f21_upb_inner.ses")))
