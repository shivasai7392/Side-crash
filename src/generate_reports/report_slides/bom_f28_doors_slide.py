# PYTHON script
"""
This script is used for all the automation process of Bill of materials f28 doors slide of thesis report.
"""
...
class BOMF28DoorsSlide():
    """
       This class is used to automate the  Bill of materials f28 doors slide of thesis report.

        Args:
            slide (object): bom f28 doors pptx slide object.
    ...
    def edit(self):
        """
        This method is used to iterate all the shapes of the bom f28 doors slide and insert respective data.
        ...
        try:
            self.logger.info("Started seeding data into bom f28 doors slide")
            self.logger.info("")
            starttime = datetime.now()
            #visualizing "f28_front_door" critical part set to capture image at original state
            ...
            #iterating through the shapes of the bom f28 fonr door
            for shape in self.shapes:
                #image insertion for the shape named "Image 1"
                if shape.name == "Image 1":
                    if self.threed_images_report_folder is not None:
                        image_path = os.path.join(self.threed_images_report_folder,self.general_input.threed_window_name+"_"+"F28_FRONT_DOOR"+".png").replace(" ","_")
                ...
                #table population for the shape named "Table 1"
                    ...
                    #iterating through f28 doors first 15 visible parts
                ...
                #table population for the shape named "Table 2"
                    ...
                    #getting the table object
                    table_obj = shape.table
                    #iterating through f28 doors remaining visible parts
                    for index,prop in enumerate(self.visible_parts[16:]):
                        part_type = parts.StringPartType(prop.type)
                        if part_type == "PSHELL":
                            part = parts.Part(id=prop.id,type = constants.PSHELL, model_id=0)
            ...
            self.logger.exception("Error while seeding data into bom f28 doors slide:\n{}".format(e))
            self.logger.info("")
            return 1
        self.logger.info("Completed seeding data into bom f28 doors slide")
