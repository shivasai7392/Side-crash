        ...
        try:
            ...
            for shape in self.shapes:
                ...
                #image insertion for the shape named "Image 2"
                    ...
                    image_path = os.path.join(self.threed_images_report_folder,self.general_input.threed_window_name+"_"+"F28_FRONT_DOOR_AT_PEAK_STATE_WITH_DEFORMATION"+".jpeg")
                ...
                #image insertion for the shape named "Image 4"
                    ...
                    image_path = os.path.join(self.twod_images_report_folder,door_panel_intrusion_window_name+"FRONT_DOOR_CURVES"+".jpeg")
