        ...
        try:
            ...
            for shape in self.shapes:
                ...
                if shape.name == "Image 1":
                    ...
                    image_path = os.path.join(self.threed_images_report_folder,self.general_input.threed_window_name+"_"+"_FRINGE_BAR"+".jpeg")
                ...
                #image insertion for the shape named "Image 2"
                    ...
                    image_path = os.path.join(self.threed_images_report_folder,self.general_input.threed_window_name+"_"+"F21_ROOF_AT_PEAK_STATE_WITH_DEFORMATION"+".jpeg")
                ...
                #image insertion for the shape named "Image 3"
                    ...
                    image_path = os.path.join(self.threed_images_report_folder,self.general_input.threed_window_name+"_"+"F21_ROOF_AT_PEAK_STATE_WITHOUT_DEFORMATION"+".jpeg")
                    capture_image_and_resize(image_path,shape.width,shape.height,rotate = Image.ROTATE_270)
                    self.logger.info("--- 3D MODEL IMAGE GENERATOR")
                    self.logger.info("")
                    self.logger.info("SOURCE WINDOW : {} ".format(self.general_input.threed_window_name))
                ...
                #image insertion for the shape named "Image 4"
                    ...
                    image_path = os.path.join(self.twod_images_report_folder,biw_stiff_ring_deformation_window_name+"_"+title.get_text()+".jpeg").replace("&","and")
                ...
                #image insertion for the shape named "Image 4"
                    ...
                    image_path = os.path.join(self.threed_images_report_folder,self.general_input.threed_window_name+"_"+"F21_ROOF_SPOTWELD_FAILURE"+".JPEG")
