# PYTHON script
"""
This script is used for all the automation process of Bill of materials row 2 f28 doors slide of thesis report.
"""
...
class BOMRow2F28DoorsSlide():
    """
       This class is used to automate the  Bill of materials row 2 f28 doors slide of thesis report.

        Args:
            slide (object): bom row 2 f28 doors pptx slide object.
    ...
    def edit(self):
        """
        This method is used to iterate all the shapes of the bom row 2 f28 doors slide and insert respective data.
        ...
        try:
            self.logger.info("Started seeding data into bom row 2 f28 doors slide")
            self.logger.info("")
            starttime = datetime.now()
            #visualizing "f28_rear_door" critical part set to capture image at original state
            ...
            for shape in self.shapes:
                ...
                if shape.name == "Image 1":
                    #capturing the "f28_rear_door" critical part set image at original state
                    if self.threed_images_report_folder is not None:
                        image_path = os.path.join(self.threed_images_report_folder,self.general_input.threed_window_name+"_"+"F28_REAR_DOOR"+".png").replace(" ","_")
            ...
            self.logger.exception("Error while seeding data into bom row 2 f28 doors slide:\n{}".format(e))
            self.logger.info("")
            return 1
