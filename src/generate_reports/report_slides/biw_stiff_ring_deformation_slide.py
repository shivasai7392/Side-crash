...
class BIWStiffRingDeformationSlide():
    """
       This class is used to automate the BIW stiff ring deformstion slide of thesis report.
    ...
    def edit(self):
        """
        This method is used to iterate all the shapes of the biw stiff ring deformation slide slide and insert respective data.

        Returns:
            int: 0 Always for Sucess,1 for Failure.
        """
        try:
            self.logger.info("Started seeding data into biw stiff ring deformation slide slide")
            self.logger.info("")
