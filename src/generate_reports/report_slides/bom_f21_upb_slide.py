        ...
        try:
            ...
            for shape in image_shapes:
                ...
                if shape.name == "Image 2":
                    ...
                    image_path = os.path.join(self.threed_images_report_folder,self.general_input.threed_window_name+"_"+"F21_UPB_INNER"+".jpeg")
                ...
                if shape.name == "Image 1":
                    ...
                    utils.MetaCommand('window maximize "{}"'.format(self.general_input.threed_window_name))
                    utils.MetaCommand('options fringebar off')
                    image_path = os.path.join(self.threed_images_report_folder,self.general_input.threed_window_name+"_"+"F21_UPB_OUTER"+".jpeg")
