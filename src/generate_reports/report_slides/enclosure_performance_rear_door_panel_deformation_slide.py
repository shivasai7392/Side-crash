        ...
        try:
            ...
            for shape in self.shapes:
                ...
                #image insertion for the shape named "Image 2"
                    ...
                    image_path = os.path.join(self.threed_images_report_folder,self.general_input.threed_window_name+"_"+"F28_REAR_DOOR_AT_PEAK_STATE_WITH_DEFORMATION"+".jpeg")
                ...
                #image insertion for the shape named "Image 3"
                    ...
                    image_path = os.path.join(self.threed_images_report_folder,self.general_input.threed_window_name+"_"+"F28_REAR_DOOR_AT_PEAK_STATE_WITHOUT_DEFORMATION"+".jpeg")
                    capture_image(image_path,self.general_input.threed_window_name,shape.width,shape.height,view = "left")
                    self.logger.info("--- 3D MODEL IMAGE GENERATOR")
                    self.logger.info("")
                    self.logger.info("SOURCE WINDOW : {} ".format(self.general_input.threed_window_name))
                ...
                #image insertion for the shape named "Image 4"
                    ...
                    image_path = os.path.join(self.twod_images_report_folder,door_panel_intrusion_window_name+"REAR_DOOR_CURVES"+".jpeg")
