# PYTHON script
"""
This script is used for all the automation process of Enclosure performance rear door panel deformation slide of thesis report.
"""
...
class EnclosurePerformanceRearDoorPanelDeformationSlide():
    """
       This class is used to automate the enclosure performance rear door panel deformation slide of thesis report.

        Args:
            slide (object): enclosure performance rear door panel deformation pptx slide object.
    ...
    def edit(self):
        """
        This method is used to iterate all the shapes of the enclosure performance rear door panel deformation slide and insert respective data.
        ...
        try:
            self.logger.info("Started seeding data into enclosure performance rear door panel deformation slide")
            self.logger.info("")
            starttime = datetime.now()
            #iterating through the shapes of the enclosure performance rear door panel deformation slide
            for shape in self.shapes:
                ...
                #image insertion for the shape named "Image 2"
                    ...
                    if self.threed_images_report_folder is not None:
                        image_path = os.path.join(self.threed_images_report_folder,self.general_input.threed_window_name+"_"+"F28_REAR_DOOR_AT_PEAK_STATE_WITH_DEFORMATION"+".png").replace(" ","_")
                ...
                #image insertion for the shape named "Image 3"
                    ...
                    if self.threed_images_report_folder is not None:
                        image_path = os.path.join(self.threed_images_report_folder,self.general_input.threed_window_name+"_"+"F28_REAR_DOOR_AT_PEAK_STATE_WITHOUT_DEFORMATION"+".png").replace(" ","_")
                        capture_image(image_path,self.general_input.threed_window_name,shape.width,shape.height,view = "left")
                        self.logger.info("--- 3D MODEL IMAGE GENERATOR")
                        self.logger.info("")
                        self.logger.info("SOURCE WINDOW : {} ".format(self.general_input.threed_window_name))
                ...
                #image insertion for the shape named "Image 4"
                    ...
                    if self.general_input.door_panel_intrusion_window_name not in ["null","none",""]:
                        door_panel_intrusion_window_name = self.general_input.door_panel_intrusion_window_name
                        door_panel_intrusion_window_obj = windows.Window(door_panel_intrusion_window_name, page_id=0)
                        if door_panel_intrusion_window_obj:
                            door_panel_intrusion_window_layout = door_panel_intrusion_window_obj.get_plot_layout()
                            ...
                            for plot in door_skin_intrusion_window_plots:
                                ...
                                if self.general_input.survival_space_final_time not in ["null","none",""]:
                                    ...
                                    if final_curves:
                                        ...
                                        self.logger.info("ERROR : Door panel intrusion window does not contain Rear '{}' curve from META 2D variable {}. Please update.".format(final_time_curve_name,GeneralVarInfo.survival_space_final_time_key))
                                        self.logger.info("")
                                else:
                                ...
                                if self.general_input.peak_time_display_value not in ["null","none",""]:
                                    ...
                                    if peak_curves:
                                        ...
                                        self.logger.info("ERROR : Door panel intrusion window does not contain Rear '{}' curve from META 2D variable {}. Please update.".format(peak_curve_re,GeneralVarInfo.peak_time_display_key))
                                        self.logger.info("")
                                else:
                            ...
                            if self.twod_images_report_folder is not None:
                                ...
                                image_path = os.path.join(self.twod_images_report_folder,door_panel_intrusion_window_name+"REAR_DOOR_CURVES"+".png").replace(" ","_")
                                capture_image_and_resize(image_path,shape.width,shape.height)
                                self.logger.info("--- 2D CURVE IMAGE GENERATOR")
                                self.logger.info("")
                                self.logger.info("CURVES : {} | SOURCE PLOT : VISIBLE PLOTS WITH IDS 1,3,5| SOURCE WINDOW : {}".format("*0MS,*150MS,*{}MS".format(peak_time),door_panel_intrusion_window_name))
                                self.logger.info("OUTPUT IMAGE SIZE (PIXELS) : {}x{}".format(round(shape.width/9525),round(shape.height/9525)))
                        ...
                        self.logger.info("ERROR : META 2D variable '{}' is not available or invalid. Please update.".format(GeneralVarInfo.door_panel_intrusion_window_key))
            endtime = datetime.now()
        except Exception as e:
            self.logger.exception("Error while seeding data into enclosure performance rear door panel deformation slide:\n{}".format(e))
            self.logger.info("")
            return 1
        self.logger.info("Completed seeding data into enclosure performance rear door panel deformation slide")
